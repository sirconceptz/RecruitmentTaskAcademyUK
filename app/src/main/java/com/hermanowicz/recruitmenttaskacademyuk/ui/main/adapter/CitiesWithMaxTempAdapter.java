...
public class CitiesWithMaxTempAdapter extends
        RecyclerView.Adapter<CitiesWithMaxTempAdapter.ViewHolder> {

    private RvSingleCityWithTempBinding binding;
    private final OnItemClickListener clickListener;
    private final List<City> cityList;
    int itemAnimPosition = -1;

    public CitiesWithMaxTempAdapter(List<City> cityList, OnItemClickListener clickListener) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        binding = RvSingleCityWithTempBinding.inflate(layoutInflater, parent, false);
